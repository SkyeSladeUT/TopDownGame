...
public class YoYo : MonoBehaviour {
    ...
    void Start ()
    {
       ...
       player = GameObject.FindWithTag("Player");// The GameObject To Return To
       sword =  GameObject.FindWithTag("BoomerangOrigin");//The Weapon The Character Is Holding In The Scene
